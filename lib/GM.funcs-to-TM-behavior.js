...
if (GM.info.toString() === "[Tampermonkey property]") return;
...
grantFuncs.forEach((funcName) => {
    ...
    switch (funcName) {
        ...
        case "GM.getResourceText":
            if (granted) break;
            if (!grantFuncs.includes("GM.getResourceUrl")) {
                console.error("GM.getResourceUrl is required for GM.getResourceText");
                break;
            }

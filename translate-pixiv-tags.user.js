...
const SITE_RULES = [
    ...
    { name: "Fanbox", host: "fanbox.pixiv.net" },
    { name: "Fanbox", domain: "pixiv.net", pathname: "/fanbox/" },
    { name: "Fanbox", domain: "pximg.net", pathname: "/fanbox/" },
    { name: "Pixiv Sketch", host: "sketch.pixiv.net" },
    { name: "Pixiv Sketch", host: "img-sketch.pixiv.net" },
    { name: "Pixiv Sketch", host: "img-sketch.pximg.net" },
    { name: "Booth", domain: "booth.pm" },
    { name: "Booth", host: "booth.pximg.net" },
    { name: "Pixiv", domain: "pximg.net" },
    { name: "Pixiv", domain: "pixiv.net" },
    { name: "Pixiv", domain: "pixiv.me" },
    { name: "Pixiv", domain: "pixiv.cc" },
    { name: "TwitPic", host: "twitpic.com" },
    { name: "TwitPic", host: "o.twimg.com" },
    { name: "TwitPic", host: "dn3pm25xmtlyu.cloudfront.net" },
    { name: "TwitPic", host: "d3j5vwomefv46c.cloudfront.net" },
    { name: "Twitter", domain: "twitter.com" },
    { name: "Twitter", domain: "twimg.com" },
    { name: "Twitter", domain: "t.co" },
    { name: "About Me", domain: "about.me" },
    { name: "Anifty", domain: "anifty.jp" },
    { name: "Anifty", host: "anifty.imgix.net" },
    { name: "Anifty", host: "storage.googleapis.com", pathname: "/anifty-media/" },
    { name: "Arca.live", domain: "arca.live" },
    { name: "Arca.live", domain: "namu.la" },
    { name: "ArtStation", domain: "artstation.com" },
    { name: "ArtStreet", domain: "medibang.com" },
    { name: "ArtStreet", host: "dthezntil550i.cloudfront.net" },
    { name: "ArtStreet", host: "dqmk835cy5zzx.cloudfront.net" },
    { name: "Bilibili", domain: "bilibili.com" },
    { name: "Bilibili", domain: "hdslb.com" },
    { name: "Deviant Art", domain: "artworkfolio.com" },
    { name: "Deviant Art", domain: "daportfolio.com" },
    { name: "Deviant Art", domain: "deviantart.net" },
    { name: "Deviant Art", domain: "deviantart.com" },
    { name: "Deviant Art", domain: "fav.me" },
    { name: "Deviant Art", domain: "sta.sh" },
    { name: "Deviant Art", host: "images-wixmp-ed30a86b8c4ca887773594c2.wixmp.com" },
    { name: "Deviant Art", host: "wixmp-ed30a86b8c4ca887773594c2.wixmp.com" },
    { name: "Deviant Art", host: "api-da.wixmp.com" },
    { name: "Enty", domain: "enty.jp" },
    { name: "Enty", host: "entyjp.s3-ap-northeast-1.amazonaws.com" },
    ...
    { name: "Foundation", host: "assets.foundation.app" },
    { name: "4chan", domain: "4cdn.org" },
    { name: "4chan", domain: "4chan.org" },
    { name: "4chan", domain: "4channel.org" },
    { name: "Furaffinity", domain: "furaffinity.net" },
    { name: "Rule34.xxx", domain: "rule34.xxx" },
    { name: "TBIB", domain: "tbib.org" },
    { name: "Gelbooru", domain: "gelbooru.com" },
    { name: "Safebooru", domain: "safebooru.org" },
    ...
    { name: "Imgur", domain: "imgur.io" },
    { name: "Instagram", domain: "instagram.com" },
    { name: "Instagram", domain: "cdninstagram.com" },
    { name: "Instagram", domain: "fbcdn.net", subdomain: /instagram/ },
    { name: "Lofter", domain: "lofter.com" },
    { name: "Lofter", domain: "127.net" },
    { name: "Lofter", domain: "lf127.net" },
    { name: "Pawoo", domain: "pawoo.net" },
    { name: "Baraag", domain: "baraag.net" },
    { name: "Misskey.io", domain: "misskey.io" },
    { name: "Misskey.io", host: "s3.arkjp.net", pathname: "/misskey/" },
    { name: "Misskey.art", domain: "misskey.art" },
    { name: "Misskey.design", domain: "misskey.design" },
    { name: "Yande.re", domain: "yande.re" },
    { name: "Konachan", domain: "konachan.com" },
    { name: "Newgrounds", domain: "newgrounds.com" },
    { name: "Newgrounds", domain: "ngfiles.com" },
    { name: "Newgrounds", domain: "ungrounded.net" },
    { name: "Nico Seiga", domain: "nicovideo.jp" },
    { name: "Nico Seiga", domain: "nicoseiga.jp" },
    { name: "Nico Seiga", domain: "nicomanga.jp" },
    { name: "Nico Seiga", domain: "nimg.jp" },
    { name: "Nico Seiga", domain: "nico.ms" },
    { name: "Nijie", domain: "nijie.net" },
    ...
    { name: "Bandcamp", domain: "bcbits.com" },
    { name: "BCY", domain: "bcy.net" },
    { name: "BCY", domain: "bcyimg.com" },
    { name: "Big Cartel", domain: "bigcartel.com" },
    { name: "Blogger", domain: "blogger.com" },
    { name: "Blogger", host: "blogger.googleusercontent.com" },
    { name: "Blogger", domain: /blogspot\.(com|ca|de|jp|kr|tw)$/i },
    ...
    { name: "Flickr", domain: "staticflickr.com" },
    { name: "GitHub", domain: "github.com" },
    { name: "GitHub", domain: "githubassets.com" },
    ...
    { name: "Line", domain: "line-apps.com" },
    { name: "LinkedIn", domain: "linkedin.com" },
    { name: "LinkedIn", domain: "licdn.com" },
    { name: "Linktree", domain: "linktr.ee" },
    { name: "Livedoor", domain: "livedoor.jp" },
    { name: "Livedoor", host: "livedoor.blogimg.jp" },
    { name: "Livedoor", domain: "2chblog.jp" },
    { name: "Livedoor", domain: "blog.jp" },
    { name: "Livedoor", domain: "bloggeek.jp" },
    { name: "Livedoor", domain: "blogism.jp" },
    { name: "Livedoor", domain: "blogo.jp" },
    { name: "Livedoor", domain: "blogstation.jp" },
    { name: "Livedoor", domain: "blogto.jp" },
    { name: "Livedoor", domain: "cafeblog.jp" },
    { name: "Livedoor", domain: "corpblog.jp" },
    ...
    { name: "Livedoor", domain: "golog.jp" },
    { name: "Livedoor", domain: "ldblog.jp" },
    { name: "Livedoor", domain: "liblo.jp" },
    { name: "Livedoor", domain: "livedoor.biz" },
    { name: "Livedoor", domain: "myjournal.jp" },
    { name: "Livedoor", domain: "mynikki.jp" },
    { name: "Livedoor", domain: "officeblog.jp" },
    { name: "Livedoor", domain: "officialblog.jp" },
    { name: "Livedoor", domain: "publog.jp" },
    { name: "Livedoor", domain: "storeblog.jp" },
    { name: "Livedoor", domain: "teamblog.jp" },
    { name: "Livedoor", domain: "techblog.jp" },
    { name: "Livedoor", domain: "weblog.to" },
    { name: "Livedoor", domain: "xxxblog.jp" },
    { name: "Livedoor", domain: "youblog.jp" },
    { name: "Lit.link", domain: "lit.link" },
    { name: "Kirby's Comic Art", domain: "kirbyscomicart.com" },
    { name: "Kirby's Comic Art", domain: "kirbyscomicartshop.com" },
    ...
    { name: "Note", host: "d291vdycu0ht11.cloudfront.net" },
    { name: "OCN", domain: "ocn.ne.jp" },
    { name: "OnlyFans", domain: "onlyfans.com" },
    { name: "OpenSea", domain: "opensea.io" },
    { name: "Overdoll", domain: "overdoll.com" },
    { name: "Overdoll", domain: "dollycdn.net" },
    { name: "Patreon", domain: "patreon.com" },
    { name: "Patreon", domain: "patreonusercontent.com" },
    { name: "Piapro.jp", domain: "piapro.jp" },
    { name: "PayPal", domain: "paypal.com" },
    { name: "PayPal", domain: "paypal.me" },
    { name: "PayPal", domain: "paypalobjects.com" },
    { name: "Pinterest", domain: "pinterest.com" },
    { name: "Pinterest", domain: "pinimg.com" },
    { name: "Pixel Joint", domain: "pixeljoint.com" },
    { name: "Postype", domain: "postype.com" },
    { name: "Postype", host: "d33pksfia2a94m.cloudfront.net" },
    ...
    { name: "Spotify", domain: "spotifycdn.com" },
    { name: "SoundCloud", domain: "soundcloud.com" },
    { name: "SoundCloud", domain: "sndcdn.com" },
    { name: "Steam", domain: "steamstatic.com" },
...
function getSiteName (siteUrl) {
    ...
    let { domain, subdomain, sld } = psl.parse(host);

    let match = SITE_RULES.find(
        (rule) => (
            typeof rule.host === 'undefined' ||
            (typeof rule.host === 'string' && rule.host === host) ||
            (rule.host instanceof RegExp && host.match(rule.host))
        ) && (
            typeof rule.domain === 'undefined' ||
            (typeof rule.domain === 'string' && rule.domain === domain) ||
            (rule.domain instanceof RegExp && domain.match(rule.domain))
        ) && (
            typeof rule.subdomain === 'undefined' ||
            (typeof rule.subdomain === 'string' && rule.subdomain === subdomain) ||
            (rule.subdomain instanceof RegExp && subdomain.match(rule.subdomain))
        ) && (
            typeof rule.pathname === 'undefined' || pathname.includes(rule.pathname)
        )
    );

    return match ? match.name : sld.charAt(0).toUpperCase() + sld.slice(1);
}

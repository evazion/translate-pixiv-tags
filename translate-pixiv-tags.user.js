...
const NETWORK_REQUEST_DICT = {
    ...
    url: {
        ...
        data_type: "string",
        fields: "normalized_url,artist[id,name,is_active,is_banned,other_names,urls[normalized_url,is_active]]",
        params (urlList) {
            return {
                search: {
...
function initializeTwitter () {
    ...
    findAndTranslate("artist", "div.r-1wbh5a2.r-dnmrzs", {
        predicate: "div[data-testid='primaryColumn'] article div:last-child>div:has(>a.r-1wbh5a2)",
        toProfileUrl: linkInChildren,
        classes: "inline",
        asyncMode: true,
        ruleName: "tweet/comment author",
